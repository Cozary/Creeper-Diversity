...
public class MudCreeperRenderer extends MobRenderer<MudCreeperEntity, CreeperRenderState, CreeperModel> {
    private static final Identifier MUD_CREEPER_LOCATION = Identifier.fromNamespaceAndPath(CreeperDiversity.MOD_ID, "textures/entity/creeper/mud_creeper.png");

    public MudCreeperRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public void extractRenderState(MudCreeperEntity entity, CreeperRenderState state, float partialTick) {
