...
public class CactusCreeperRenderer extends MobRenderer<CactusCreeperEntity, CreeperRenderState, CreeperModel> {
    private static final Identifier CACTUS_CREEPER_LOCATION = Identifier.fromNamespaceAndPath(CreeperDiversity.MOD_ID, "textures/entity/creeper/cactus_creeper.png");
    ...
    @Override
    public void extractRenderState(CactusCreeperEntity entity, CreeperRenderState state, float partialTick) {
    ...
    public Identifier getTextureLocation(CreeperRenderState state) {
        return CACTUS_CREEPER_LOCATION;
    }
}
